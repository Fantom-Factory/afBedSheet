...
//		mCall := (MethodCall?) Route(regex, method).match(httpReq)
...
//		verifyErrMsg(ArgErr#, BsErrMsgs.route_uriWillNeverMatchMethod(`/route/***`, #handler1)) {
...
//			r := Route(`/route/*`,   #handler1)
//		}
//		verifyErrMsg(ArgErr#, BsErrMsgs.route_uriWillNeverMatchMethod(`/route/*/***`, #handler2)) {
...
//		}
//		
//		verifyErrMsg(ArgErr#, BsErrMsgs.route_uriWillNeverMatchMethod(`/route/*`, #handler6)) {
